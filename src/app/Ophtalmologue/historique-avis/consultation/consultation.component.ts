...
commentaireDroite : string ; 
commentaireGauche : string ; 
...
getConsultationDroite(){
  ...
  this.commentaireDroite = this.consultation.autoDetection.avisExpert.commentaireDroite;
  this.commentaireGauche = this.consultation.autoDetection.avisExpert.commentaireGauche;
